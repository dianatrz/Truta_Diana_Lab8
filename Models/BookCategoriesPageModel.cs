...
namespace Truta_Diana_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Truta_Diana_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Truta_Diana_Lab8Context context,
